...
class ListEntry extends VBoxContainer:
	...
	func setup_buttons() -> void:
		...
		margin_container.add_theme_constant_override("offset_top", 5)
		margin_container.add_theme_constant_override("offset_left", 5)
		margin_container.add_theme_constant_override("offset_right", 5)
