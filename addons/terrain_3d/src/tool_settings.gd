...
func _ready() -> void:
	...
	add_setting({ "name":"enable_texture", "label":"Texture2D", "type":SettingType.CHECKBOX, 
								"list":main_list, "default":true, "flags":ADD_SEPARATOR })

	add_setting({ "name":"texture_filter", "label":"Texture2D Filter", "type":SettingType.CHECKBOX, 
