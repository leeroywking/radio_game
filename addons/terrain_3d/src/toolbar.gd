...
func _ready() -> void:
	...
	add_tool_button({ "tool":Terrain3DEditor.TEXTURE, 
		"add_text":"Paint Texture2D (B)", "add_op":Terrain3DEditor.REPLACE, "add_icon":ICON_PAINT_TEXTURE })

	add_tool_button({ "tool":Terrain3DEditor.TEXTURE, 
		"add_text":"Spray Texture2D (V)", "add_op":Terrain3DEditor.ADD, "add_icon":ICON_SPRAY_TEXTURE })
	...
	add_tool_button({ "tool":Terrain3DEditor.NAVIGATION,
		"add_text":"Paint Navigable Area3D (N)", "add_op":Terrain3DEditor.ADD, "add_icon":ICON_NAVIGATION,
		"sub_text":"Remove Navigable Area3D (N)", "sub_op":Terrain3DEditor.SUBTRACT })
